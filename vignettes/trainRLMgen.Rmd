---
title: "trainR: basic landmark data generation example explained"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{trainR: basic landmark data generation example explained}
...
**This will be run on a separate thread (or `R` session) from the `trainRLMtrain.Rmd`
code.**

---
title: "trainR: basic landmark unet training example explained"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{trainR: basic landmark unet training example explained}
...
We assume you ran the `trainRLMgen.Rmd` already.

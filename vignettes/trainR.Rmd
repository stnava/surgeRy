...
```{r training,echo=TRUE,eval=FALSE}
ptWeight = tf$cast( 0.005, mytype )
# Training loop parameters -----------------------------------------------------
num_epochs <- 5000
optimizerE <- tf$keras$optimizers$Adam(5.e-6)
batchsize = 2
